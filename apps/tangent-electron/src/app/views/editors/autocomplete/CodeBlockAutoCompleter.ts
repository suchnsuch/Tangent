import { TextDocument, type EditorRange, Editor } from 'typewriter-editor'
...
import { type SearchMatchResult, buildFuzzySegementMatcher, compareNodeSearch } from 'common/search'
